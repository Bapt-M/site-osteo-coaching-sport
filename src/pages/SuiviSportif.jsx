      ...
      <section className="py-24 px-6">
        <div className="max-w-[1360px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <h2 className="font-syne font-bold text-text-primary text-4xl md:text-5xl mb-8 leading-tight">
          ...
          >
            {MODALITES.map((m) => (
              ...
              >
                ...
                <span className="font-syne font-semibold text-text-primary text-lg">{m.title}</span>
              </motion.div>
            ))}
          </motion.div>
      ...
      <section className="py-24 px-6 bg-green-deep/5">
        <div className="max-w-[1360px] mx-auto">
          ...
          >
            ...
            <h2 className="font-syne font-bold text-text-primary text-4xl md:text-5xl leading-tight">
              Avant &amp; après
            </h2>
          </motion.div>
