  ...
  return (
    <section id="testimonials" className="py-24 md:py-36 px-6 bg-green-deep">
      <div className="max-w-[1360px] mx-auto">
        ...
        >
          <div className="inline-block px-3 py-1 rounded-full bg-green-accent/20 text-cyan-accent font-syne font-bold text-xs tracking-widest mb-4">
            TÉMOIGNAGES
          </div>
        ...
        >
          {TESTIMONIALS.map(t => (
            ...
            >
              <div className="text-5xl font-syne font-bold text-cyan-accent/40 leading-none mb-4">"</div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-syne font-bold text-white text-sm">{t.author}</div>
